                            ...
                            <tbody id="tbody">
                                @foreach ($invoice->details as $detail)
                                    <tr class="item">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <select name="material[]" class="form-select material" value="" required>
                                                    @foreach ($materials as $material)
                                                        <option value="{{ $material->id }}" {{ $detail->material->id == $material->id ? 'selected' : '' }}>{{ $material->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <input type="text" name="quantity[]" class="form-control quantity" value="{{ $detail->qty }}" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" name="total_price[]" class="form-control total_price" value="{{ $detail->total_price }}"
                                                    readonly>
                                            </div>
                                        </td>
                                        <td>
...
<script>
    $(document).ready(function () {
        ...
        let currentIndex = "{{ count($invoice->details) }}"; // Initialize the current index
